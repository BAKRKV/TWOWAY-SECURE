    ...
    <div class="container">
        <div class="row ">
            ...
            <div class="col-md-8 py-5 border">
                ...
                <form action="RegSDB.jsp" method="post">
                    <div class="form-row">
                      ...
                      <div class="form-row">
                        <div class="form-group col-md-12">
                            <input type="password" name="Full" placeholder="Password" class="form-control" type="text" required="">
                        </div>
                      </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select id="inputState" class="form-control" name="ab">
                                    ...
                                    <option name="ab" value="100"> 100 GB</option>
                                    <option name="ab" value="200"> 200 GB</option>
                                    <option name="ab" value="300"> 300 GB</option>
                                    <option name="ab" value="500"> 500 GB</option>
                                  </select>
                        </div>
